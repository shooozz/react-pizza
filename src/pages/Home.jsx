...
const Home = ({ searchValue, setSearchValue }) => {
    ...
    const [tempOffset, setTempOffset] = React.useState('')
    ...
    React.useEffect(() => {
        ...
        const categoryFetch =
            indexCategories > 0
                ? `filterByFormula=%7Bcategory%7D%3D${indexCategories}&
        ...
        //         .get(
        //             `${url}?
        // &sort%5B0%5D%5Bfield%5D=${sortBy}&sort%5B0%5D%5Bdirection%5D=${sortOrder}&pageSize=${pageSize}&offset=${tempOffset}`,
        //             {
        //                 headers: {
        ...
        //                 setTempOffset(response.data.offset)
        //             }
        //         })
        // }
    ...
    return (
        <>
            ...
            <Pagination onChangePage={number => setCurrentPage(number)} setIndexCategories={() => setIndexCategories(0)} />
        </>
    )
}
